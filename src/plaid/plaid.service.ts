...
export class PlaidService {
  ...
  //     // const responseData = response.data as ItemPublicTokenExchangeResponse;
  //     return response.data;
  //   } catch (error) {
  //     if (error.response) {
  //       this.logger.error('Plaid API Response Data:', error.response.data);
  //     }
  ...
  // async createSandboxPublicToken(): // createSandboxPublicTokenDto: CreateSandboxPublicTokenDto,
  // // institutionID,
  // // initialProductNames,
  // Promise<string> {
  //   // const { institutionID, initialProductNames } = createSandboxPublicTokenDto;
  //   const institutionID = 'ins_109508';
  //   const initialProductNames: Products[] = [Products.Transactions]; // Use enum value

  //   const publicTokenRequest: SandboxPublicTokenCreateRequest = {
  //     institution_id: institutionID,
  //     initial_products: initialProductNames, // Plaid type limitation workaround
  //   };
  //   try {
